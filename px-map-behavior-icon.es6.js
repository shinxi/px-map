...
(function () {
  ...
  class StaticIcon {
    ...
    createIcon(settings = {}) {
      ...
      const popupAnchor = L.point(0, -31);
        ...
        <div class="map-icon-symbol__wrapper">
          <i class="map-icon-symbol__body" style="${customStyleBackground}">
            <div class="map-icon-symbol__symbol--container flex flex--middle flex--center">
              <px-icon icon="${icon}"
                style="stroke:${stroke}; fill:${fill}; width:100%; height:100%;
  ...
  class ClusterIcon {
    ...
    createIcon(settings = {}) {
      ...
      const html = `
        <div class="map-icon-cluster__container" style="width: ${containerSize}px;
